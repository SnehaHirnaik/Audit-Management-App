...
public class ProjectManagerDetailsServiceTest{
	...
	public void loadUserByUsernameTest() throws UsernameNotFoundException {
		...
		assertNotNull(new ProjectManagerDetails(projectManager).getPassword());
		assertEquals(true,new ProjectManagerDetails(projectManager).isAccountNonExpired());
		assertEquals(true,new ProjectManagerDetails(projectManager).isAccountNonLocked());
		assertEquals(true,new ProjectManagerDetails(projectManager).isCredentialsNonExpired());
		assertEquals(true,new ProjectManagerDetails(projectManager).isEnabled());
		assertNotNull(new ProjectManagerDetails(projectManager).getAuthorities());
